...
#include "Menu_Drv.h"
  ...
  // table of double-click codes
  typedef enum double_click_codes
  {
    CS_SF = 0x0100, SF_CS = 0x1000, A_O = 0x2300, O_A = 0x3200
  }double_click_codes_t;
  ...
  extern void sweep_freq_control( int cur_channel );
